...
This project is indexed by GitNexus as **IntelligentWaterChannel-gpt** (1653 symbols, 3315 relationships, 138 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
